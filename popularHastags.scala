 ...
 *  hashtags over a 2 minute window.
 */
object PopularHashtags {
  ...
  def main(args: Array[String]) {
    ...
    // all CPU cores and one-second batches of data - one second at a time
    ...
    // Now count them up over a 10 minute window sliding every one second
